...
**GET** `{{url}}/api/invoice?invoice_type=aeronautical&billing_period=2026-04-01,2026-05-10`
...
| Name | Value | Type |
|---|---|---|
| `invoice_type` | `aeronautical` | query |
| `billing_period` | `2026-04-01,2026-05-10` | query |
| `billing_period_end` | `2026-05-10` | query |
