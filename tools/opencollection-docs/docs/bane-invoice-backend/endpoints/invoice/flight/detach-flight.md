...
**PATCH** `{{url}}/api/flight/detach-flight/`
...
### Detach flight failed.

**Request:** `PATCH` `{{url}}/api/flight/detach-flight/`
...
```json
{
    ...
    "error": null,
    "errors": {
        "flight": "Billing Flight not found in the company"
    }
}
```

### Detach flight success
...
{
    "status": "success",
    "message": "Flight detached successfully",
    "data": {
        "result": {
            "id": 128,
            "call_sign": "abcdddd",
            "flight_no": "asdfsdfsdaf",
            "flight_type": "landing",
            ...
            "dest": "",
            "flight_source_data": "{\n}",
            "flight_reference_number": "",
            "flight_source": "adsb",
            "status": "ready_to_bill",
            "fir_in": "2024-12-12T13:40:00+06:00",
            "fir_out": "2024-12-12T14:42:00+06:00",
            "fir_in_route": "",
            "fir_out_route": "",
            "flight_purpose": "cargo_flight",
            "date_of_operation": "2024-12-12",
            "operator": 107,
            "operator_name": "Ismail Hasan Sarker",
            "charges_amount": 856.4,
            "log": [
                {
                    "id": 4939,
                    "type": "update",
                    ...
                    "status": "success",
                    "created_at": "2024-12-19T13:38:57.685180+06:00"
                }
            ],
            "invoice_id": null,
            "invoice_no": null,
            "flight_charges_amount": 736.4,
            "flight_charges": {
                "landing": {
                    "total_charge": -63.6,
                    "parameter_value": 0,
